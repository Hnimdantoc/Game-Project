all:
	...
	g++ -I src/headers -I src/include -L src/lib -o bin/main src/compile/*.cpp src/resources/resources.res -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer -mwindows
debugvscode:
	make clean
